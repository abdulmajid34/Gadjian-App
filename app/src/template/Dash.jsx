                        ...
                        <div class="flex items-center">
                            ...
                            <div class="relative">
                                ...
                                <div
                                    ...
                                    style={{ display: 'none'}}>
                                    <span
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Profile</span>
                                    <span
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Products</span>
                                    <span
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white">Logout</span>
                                </div>
                            </div>
                        </div>
                    </header>
